...
describe('way.test', () => {
    describe('wayToLineString', () => {
        ...
        it('should not work when correct coords provided with wrong geometry', () => {
            expect(() => wayToLineString(Geometry.POINT, [[1, 2], [2, 3], [3, 0], [1, 2]])).toThrow();
        });
        ...
        it('should work when correct coords provided', () => {
            expect(() => wayToLineString(Geometry.AREA, [[1, 2], [2, 3], [3, 0], [1, 2]])).not.toThrow();
        });
        it('should behave...', () => {
            expect(wayToLineString(Geometry.AREA, [[1, 2], [2, 3], [3, 0], [1, 2]])).toMatchSnapshot();
        });
    });
...
//# sourceMappingURL=wayToFeature.test.js.map